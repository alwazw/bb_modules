...
sudo docker compose exec web_interface python3 main_acceptance.py
...
sudo docker compose exec web_interface python3 main_shipping.py
...
sudo docker compose exec web_interface python3 main_tracking.py
